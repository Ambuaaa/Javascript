...
console.log(myHeros); // [ "shaktiman " , " joker "]
...
myArr.pop()
console.log(myArr); // removes the last element  => [0, 1, 2, 3, 4, 5, 6 ] 
...
console.log(myArr.indexOf(3)); // 4 (here)

myArr.shift()
console.log(); // deletes the first element  // 0,1,2,3,4,5,6
...
console.log("C" , myArr); // C [0 , 4 , 5 , 6 , 7 ] // changed the original array
